...
export default function VozEntryPage() {
  ...
  async function finishRecording() {
    ...
    const { data, fallo } = await invokeAi<AiMealEstimateResponse>(supabase, "analyze-voice", {
      audio: { data: base64, mimeType: blob.type || "audio/webm" },
    });
    if (fallo) {
      ...
      setState({ kind: "error", message: mensajeDeFallo(fallo, "analizar el audio") });
      return;
    }
